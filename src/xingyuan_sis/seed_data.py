...
# Keep the original twelve demo students stable so older examples, screenshots
# and tests that refer to their student numbers remain meaningful.
_BASE_STUDENTS = (
...
# Names below intentionally reference established furry / anthropomorphic works.
# Works with well-established Chinese names use those translations; otherwise
# the original character name is kept. Species are kept close to the source.
_CHARACTER_PROFILES = (
    # BEASTARS
    ('雷格西', '犬科', '灰狼', '男'),
    ('春', '兔科', '侏儒兔', '女'),
