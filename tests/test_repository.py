...
class RepositoryTests(unittest.TestCase):
    ...
    def _stone_cat_id(self) -> int:
        family_id = self.repository.add_species_family("猫科")
        return self.repository.add_species_branch("石虎", family_id)
    ...
    def test_complete_student_course_workflow(self) -> None:
        ...
        species_branch_id = self._stone_cat_id()
        ...
        self.assertEqual(students[0]["family"], "猫科")
        self.assertEqual(students[0]["branch"], "石虎")
