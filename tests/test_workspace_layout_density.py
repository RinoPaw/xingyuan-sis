...
class WorkspaceLayoutDensityTests(unittest.TestCase):
    ...
    def test_split_gives_requested_inspector_width_and_roster_the_rest(self):
        layout = WorkspaceLayout(160, 35, 28)
        self.assertEqual(layout.split_x, 128)
        self.assertEqual(layout.panel_width, 28)

    def test_layout_without_semantic_context_uses_only_conservative_default(self):
        layout = WorkspaceLayout(160, 35)
        self.assertEqual(layout.split_x, 128)
        self.assertEqual(layout.panel_width, 28)

    def test_medium_split_honors_wide_inspector_request(self):
        layout = WorkspaceLayout(80, 30, 42)
        self.assertEqual(layout.split_x, 34)
